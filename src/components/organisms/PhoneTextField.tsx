...
const PhoneTextField = forwardRef<HTMLInputElement, PhoneTextFieldProps>(
  function PhoneTextField(
    ...
    const filteredCountries = getCountryCodes().filter(
      (country) =>
        ...
        >
          ...
          <div className="relative" ref={dropdownRef}>
            <IconButton
              ...
              disabled={disabled}
              variant="ghost"
              className="justify-start w-20 !p-0"
              icon={
                <>
                  <span className="font-ariom font-bold text-base">
          ...
          <TextField ref={ref} className="border-none" {...props} />
        </div>
        {error && (
