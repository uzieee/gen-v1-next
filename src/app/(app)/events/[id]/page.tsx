...
import { fetchEvent } from "@/app/services/http/events";
import EventDetailSkeleton from "@/components/skeletons/EventPageSkeleton";
...
export default function EventDetailsPage() {
  ...
  const { data: event, isSuccess: isFetchEventSuccess } = useApiQuery({
    apiHandler: fetchEvent,
    payload: { key: id as string },
    queryKey: ["events", id],
  });
  ...
  const truncatedText = truncateText(event?.about || "", 135);
  const shouldShowMore = (event?.about || "").length > 135;
    ...
    <>
        ...
        <Header
          ...
          rightIcon={
            <svg
              ...
              className="text-main-300 !w-6 !h-6"
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M9.75 18.5C9.75 18.0858 10.0858 17.75 10.5 17.75H14.5C14.9142 17.75 15.25 18.0858 15.25 18.5C15.25 18.9142 14.9142 19.25 14.5 19.25H10.5C10.0858 19.25 9.75 18.9142 9.75 18.5Z"
                fill="currentColor"
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M12.5 15.75C12.9142 15.75 13.25 16.0858 13.25 16.5V20.5C13.25 20.9142 12.9142 21.25 12.5 21.25C12.0858 21.25 11.75 20.9142 11.75 20.5V16.5C11.75 16.0858 12.0858 15.75 12.5 15.75Z"
                fill="currentColor"
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M7.98863 1.75C5.95225 1.75 4.30033 3.40413 4.30863 5.43694L4.30864 5.44C4.30863 7.42302 5.85771 9.03198 7.81352 9.11885C7.9321 9.1106 8.05737 9.1102 8.17556 9.11876C10.122 9.03083 11.6786 7.42113 11.6786 5.44C11.6786 3.40421 10.0244 1.75 7.98863 1.75ZM2.80863 5.44153C2.79776 2.57504 5.12552 0.25 7.98863 0.25C10.8528 0.25 13.1786 2.57579 13.1786 5.44C13.1786 8.24456 10.9579 10.5259 8.18393 10.6196C8.15059 10.6207 8.1172 10.6196 8.084 10.6163C8.03578 10.6115 7.96372 10.6108 7.89653 10.6169C7.86559 10.6197 7.83449 10.6206 7.80344 10.6196C5.01873 10.526 2.80944 8.2442 2.80863 5.44153Z"
                fill="currentColor"
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M7.98406 12.9301C6.28315 12.9301 4.62192 13.3632 3.39613 14.1834L3.39449 14.1845L3.39449 14.1845C2.34107 14.8853 1.91406 15.7356 1.91406 16.4913C1.91406 17.2474 2.34146 18.1005 3.3957 18.8064C4.62727 19.6273 6.28397 20.0601 7.98906 20.0601C8.40328 20.0601 8.73906 20.3958 8.73906 20.8101C8.73906 21.2243 8.40328 21.5601 7.98906 21.5601C6.05444 21.5601 4.0914 21.073 2.56304 20.0541L2.56185 20.0533C1.1965 19.1393 0.414062 17.8626 0.414062 16.4913C0.414062 15.1198 1.19674 13.8453 2.56281 12.9362C4.08691 11.9167 6.05533 11.4301 7.98406 11.4301C9.91315 11.4301 11.8819 11.9169 13.4061 12.9367C13.7504 13.1671 13.8427 13.6329 13.6124 13.9771C13.3821 14.3214 12.9163 14.4137 12.572 14.1834C11.3462 13.3632 9.68498 12.9301 7.98406 12.9301Z"
                fill="currentColor"
              />
            </svg>
          }
      ...
      <div className="px-6 flex flex-col gap-6">
        ...
        <div className="flex items-center gap-3 justify-between">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-main-600 font-medium text-sm font-ariom">
        ...
        <div className="flex flex-col gap-1">
          <div className="text-main-600 text-3xl font-medium font-ariom">
            About
          </div>
          <div className="text-secondary text-sm font-normal font-hellix">
            <p>
              {isExpanded ? event.about : truncatedText}
        ...
        <div className="pt-5 pb-8 flex flex-col gap-2">
          <div className="text-main text-3xl font-bold font-ariom">
            Location
          </div>
          <div className="bg-black/20 flex items-center justify-center h-36 rounded-4xl w-full">
            <div className="bg-secondary flex items-center gap-3 py-1.5 px-2 rounded-lg">
              ...
              <div className="text-background font-ariom font-medium">
                <h4 className="text-sm">{event.streetAddress}</h4>
                <p className="text-[10px]">{event.streetAddress}</p>
              </div>
            </div>
            <div></div>
          </div>
