...
export default function HomeDashboard() {
  ...
  const communityProfiles = [
    ...
    },
    {
      ...
      status: "Offline",
      icon: '⚡',
      image: "/images/advanced-technological-robot-interacting-with-money-finance.jpg"
    }
  ];
        ...
        <div className="pr-3.5 mb-12">
          <div className="flex items-center justify-between">
            <div className='text-main font-syne font-semibold'>
              <p className="text-lg">Morning Lex</p>
        ...
        <div className="flex flex-col gap-6 mb-7">
          ...
          <div className="flex items-center overflow-x-auto">
            {upcomingEvents.map((event) => (
              <EventCard key={event.id} event={event} isLoading={eventsLoading} />
            ))}
          </div>
        </div>
