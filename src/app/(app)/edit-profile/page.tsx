...
export default function EditProfile() {
    ...
    const handleImageUpload = () => {
        ...
        if (file) {
            ...
            reader.onload = (e) => {
            setProfileImage((e.target as FileReader).result as unknown as string | null);
            };
    ...
    return (
        <>
            ...
            >
                <div className="flex flex-col gap-14">
                    ...
                    <div className="flex flex-col gap-8">
                        <div className="flex flex-col gap-6">
                            <div className="text-lg font-ariom font-medium text-main-600">Your phone number</div>
                            <TextField
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="text-lg font-ariom font-medium text-main-600">Name</div>
                            <TextField
                            {...register("name")}
                            icon={
                                <svg
                ...
                <FormSubmitButton defaultText="Save Changes" state={isValid ? "default" : "disabled"} />
            </form>
        </>
    );
}
