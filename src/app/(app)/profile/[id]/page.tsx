...
import { fetchUser } from "@/app/services/http/users";
...
import { cn, getProfessionSummary, getStartupSummary } from "@/lib/utils";
import {
  Attribute,
  AttributeCategory,
  Profession,
...
export default function Profile() {
  ...
  const { data, isSuccess: isFetchUserSuccess } = useApiQuery({
  ...
  const userProfile = useMemo(() => {
    ...
    return {
      ...
      images: [
        ...
        ...(user.galleryImages ?? []).map((g: any) => g.url), // gallery
